 ...
 *
 * Modificado por Vinícius Lage 
 * última modificação: 12/11/2014
 *
 */
  ...
  $(this)
    .each(function() {
      var
		...
		$vResponse,	 	////////////////////////////////// MODIFICADO PARA AUTOCOMPLETE
      ...
      module = {
        ...
        results: {
          generate: function(response) {
			...
			if(settings.autoComplete) 	////////////////////////////////// MODIFICADO PARA AUTOCOMPLETE
				$vResponse = response.results;  
          ...
          select: function(event) {
			...
			if(settings.autoComplete)			////////////////////////////////// MODIFICADO PARA AUTOCOMPLETE
			{
				var $vIndex  = $result.index();			
				for( var att in $vResponse[$vIndex] )
					$("input[data-autocomplete-name='"+att+"']").val( $vResponse[$vIndex][att] );
			}
...
$.fn.search.settings = {
  ...
  autoComplete   : false,			////////////////////////////////// MODIFICADO PARA AUTOCOMPLETE
  ...
  error : {
    ...
    noResults   : 'A busca nao retornou resultados.',
